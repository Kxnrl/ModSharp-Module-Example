...
namespace Kxnrl.Sparkle.Modules.SharedInterfaceExample;

internal sealed class SharedInterface : IModule, ISparkleKendama
{
    ...
    {
        _bridge.SharpModuleManager.RegisterDynamicNative(_bridge.Sparkle, $"{ISparkleKendama.Identity}.Hi",    Hi);
        _bridge.SharpModuleManager.RegisterDynamicNative(_bridge.Sparkle, $"{ISparkleKendama.Identity}.Hello", Hello);

        _bridge.SharpModuleManager.RegisterSharpModuleInterface(_bridge.Sparkle, ISparkleKendama.Identity, this);
    }
