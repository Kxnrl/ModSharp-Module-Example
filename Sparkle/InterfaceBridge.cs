...
internal sealed class InterfaceBridge
{
    ...
    public InterfaceBridge(string dllPath, string sharpPath, Version version, Sparkle sparkle, ISharedSystem sharedSystem)
    {
        SharpPath          = sharpPath;
        DllPath            = dllPath;
        ...
        FileVersion        = FileVersionInfo.GetVersionInfo(Path.Combine(dllPath, "Sparkle.dll"));
